    ...
    try {
      const response = await axios.get(apiUrl + "pdf/generate/", {
        responseType: "blob", headers: {
          accept: "application/json", Authorization: `Bearer ${message}`,
        },
      });
  ...
  const getPaymentStatus = async (paymentId, signature) => {
    try {
      const res = await fetch(apiUrl + "payment/verify/", {
        method: "POST", headers: {
          "Content-Type": "application/json", Authorization: `Bearer ${message}`,
        }, body: JSON.stringify({
...
const handleUpload = async (event) => {
  ...
  return (<div className="my-20-5  overflow-y-scroll">
    <Link href="/">
    ...
    <div className="flex md:flex-row  flex-col justify-center gap-3 items-center ">
      {/* Program Details */}
      {paid ? (<div className="bg-white rounded-lg  shadow-lg p-6 max-w-3xl mx-auto ">
      ...
      {paid ? (<div className="bg-white rounded-lg shadow-lg p-5 min-w-[40%] align-middle justify-center  mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
          {user.pref_loc == "Kochi" ? (<div className="flex justify-center p-5 items-center h-[400px]">
            <iframe
              className="m-4"
            ...
            ></iframe>
          </div>) : user.pref_loc === "Kozhikode" ? (<div className="flex justify-center items-center h-[400px] p-5">
            <iframe
              ...
              referrerPolicy="no-referrer-when-downgrade"
            ></iframe>
          </div>) : (<div className="flex justify-center items-center h-[400px] p-5">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d62865.98242584101!2d76.28940321683658!3d10.006623109668615!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b080c058ff7a4cd%3A0xa9c697fee1e03c65!2sGovernment%20Medical%20College%20Ernakulam!5e0!3m2!1sen!2sin!4v1679807141846!5m2!1sen!2sin"
              width="90%"
              height="90%"
