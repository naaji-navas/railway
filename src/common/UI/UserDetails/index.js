...
// a javascript function to download the pdf from an api responseresult
  ...
  return (
    <div className="my-20-5  overflow-y-scroll">
      ...
      <div className="flex md:flex-row  flex-col justify-center gap-3 items-center h-screen">
        {/* Program Details */}
        {paid ? (
          <div className="bg-white rounded-lg hidden md:block shadow-lg p-6 max-w-3xl mx-auto ">
            ...
            <div className="justify-center mt-6">
              <a href="https://chat.whatsapp.com/HacGrs1p4h56I84MMt3bkS" target="_blank" rel="noopener noreferrer">
        ...
        {paid ? (
          <div className="bg-white rounded-lg shadow-lg p-6 md:hidden block max-w-3xl mx-auto ">
            <h1 className="text-2xl font-bold mb-4 text-center text-indigo-700">
              Program Details
            </h1>
            <div className="flex flex-col gap-4 text-lg">
